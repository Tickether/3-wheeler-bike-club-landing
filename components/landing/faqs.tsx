...
export function FAQs() {
    return (
        <div className="flex max-sm:flex-col-reverse w-full mb-36 h-full items-center justify-center gap-20">
            <div className="flex w-2/5 max-md:w-full max-md:h-2/5 items-center justify-center max-sm:w-60 max-sm:h-60">
            ...
            <div className="flex flex-col gap-6 max-md:gap-2 w-2/5 max-md:w-full max-md:h-2/5 items-center justify-center">
                <div className="flex flex-col gap-2">
                    <h1 className="text-3xl max-md:text-xl max-sm:text-base font-semibold max-sm:text-center">Frequently Asked Questions</h1>
                    <p className="text-sm max-md:text-xs max-sm:text-[10px] max-sm:text-center">Here are some of the most common inquiries we receive to help you make informed decisions with confidence. If you need more details, feel free to reach out!</p>
                </div>
                <div className="w-full">
                    <Accordion type="single" collapsible className="w-full">
                        <AccordionItem value="item-1">
                            ...
                            <AccordionContent className="px-4 max-sm:text-[8px]">

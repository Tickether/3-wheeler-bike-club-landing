        ...
        <div className="flex max-sm:flex-col w-full mb-36 h-full items-center justify-center gap-20 max-md:gap-10">
                <div className="flex flex-col gap-4 w-2/5 max-md:w-full max-md:h-2/5 items-center justify-center">
                    ...
                    <div className="flex flex-col gap-4">
                        <p className="text-lg max-md:text-xs max-sm:text-[10px] max-sm:text-center">{"3 Wheeler Bike Club is a Membership Club for 3-Wheeler(TukTuk/Pragia/Keke) Bikers built on the pillars of Ownership, Community & Governance."}</p>
